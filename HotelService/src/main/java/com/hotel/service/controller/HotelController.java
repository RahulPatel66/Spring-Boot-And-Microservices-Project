...
public class HotelController {
	...
	public ResponseEntity<String> delteHotel(@PathVariable String hotelId)
	{
		return ResponseEntity.status(HttpStatus.OK).body(hotelservice.deleteHotel(hotelId));
	}
	
	@PutMapping("/{hotelId}")
	public ResponseEntity<Hotel> updateHotel(@RequestBody Hotel hotel , @PathVariable Hotel hotelId)
	{
