...
//	}
	...
	{
		return ResponseEntity.status(HttpStatus.OK).body(ratingservice.ratingByHotelId(hotelId));
	}
...
//	
//	@PutMapping("/{ratingId}")
//	public ResponseEntity<Rating> deleteRating(@PathVariable String ratingId , @RequestBody Rating rating)
//	{
//		return ResponseEntity.status(HttpStatus.OK).body(ratingservice.updateRatings(rating));
//	}
}
